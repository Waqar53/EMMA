                    ...
                    <tbody>
                        ...
                        <tr style={{ background: 'var(--bg-glass)' }}>
                            ...
                            <td>
                                ...
                                <div style={{ fontSize: '0.6875rem', color: 'var(--text-muted)' }}>Duration: 4m 12s</div>
                            </td>
                            ...
                            <td><span style={{ color: 'var(--red-500)', fontWeight: 600, fontSize: '0.8125rem' }}>Requires GP<br />Review</span></td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <div style={{ fontSize: '0.6875rem', color: 'var(--text-muted)' }}>Duration: 2m 45s</div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div style={{ fontSize: '0.6875rem', color: 'var(--text-muted)' }}>Duration: 6m 08s</div>
                            </td>
                            <td><span className="badge badge-triage">Clinical Triage</span></td>
                            <td><span className="badge badge-urgent">URGENT</span></td>
                            <td><span style={{ color: 'var(--text-muted)', fontSize: '0.8125rem' }}>⏱ GP Audited</span></td>
                        </tr>
                    </tbody>
                </table>
