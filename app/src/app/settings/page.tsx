        ...
        <main className="page-content">
            ...
            <div className="setting-section">
                ...
                <div className="grid-2col">
                    ...
                    <div>
                        ...
                        <div style={{ fontSize: '0.6875rem', color: 'var(--text-muted)', marginBottom: '12px' }}>Enable AI translation for patients whose primary language is not English.</div>
                        ...
                        <button className="btn btn-sm" style={{ color: 'var(--brand-blue)', borderColor: 'var(--brand-blue)' }}>+ Add Language</button>
                    </div>
                </div>
            </div>
            ...
            <div className="setting-section">
                ...
                <div style={{ padding: '12px 16px', textAlign: 'center' }}>
                    <a href="#" style={{ color: 'var(--brand-blue)', fontSize: '0.8125rem', fontWeight: 500, textDecoration: 'none' }}>View all 24 knowledge articles</a>
                </div>
            </div>
                ...
                <table className="data-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>GP / Lead Nurse</td>
                            <td><code style={{ fontSize: '0.6875rem', padding: '2px 6px', background: 'var(--bg-glass)', borderRadius: '4px' }}>15MIN_FACE</code></td>
                            <td><span style={{ color: 'var(--green-500)', fontWeight: 600, fontSize: '0.8125rem' }}>● Active</span></td>
                        </tr>
                        <tr>
                            <td>Medication Review</td>
                            <td>Clinical Pharmacist</td>
                            <td><code style={{ fontSize: '0.6875rem', padding: '2px 6px', background: 'var(--bg-glass)', borderRadius: '4px' }}>TEL_REVIEW</code></td>
                            <td><span style={{ color: 'var(--green-500)', fontWeight: 600, fontSize: '0.8125rem' }}>● Active</span></td>
                        </tr>
                        <tr>
                            <td>Child Immunisation</td>
                            <td>Practice Nurse</td>
                            <td><code style={{ fontSize: '0.6875rem', padding: '2px 6px', background: 'var(--bg-glass)', borderRadius: '4px' }}>IMMUN_SLOT</code></td>
                            <td><span style={{ color: 'var(--text-muted)', fontWeight: 500, fontSize: '0.8125rem' }}>● Disabled</span></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            {/* Version Footer */}
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '16px 0', fontSize: '0.6875rem', color: 'var(--text-muted)' }}>
                <div>
                    <span style={{ background: 'var(--bg-glass)', padding: '4px 10px', borderRadius: '6px', fontWeight: 500 }}>CURRENT VERSION</span>
                    <span style={{ marginLeft: '8px', fontWeight: 600, color: 'var(--text-secondary)' }}>EMMA v2.4.12</span>
                    <span style={{ marginLeft: '6px', padding: '2px 8px', background: 'var(--green-bg)', color: 'var(--green-500)', borderRadius: '4px', fontWeight: 600 }}>LIVE</span>
                </div>
            </div>
